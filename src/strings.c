...
#if (DECAP_ENABLED) && !(DECAP_MAIN_MENU)
const u8 gText_MainMenuNewGame[] = _C("NEW GAME");
const u8 gText_MainMenuContinue[] = _C("CONTINUE");
const u8 gText_MainMenuOption[] = _C("OPTION");
const u8 gText_MainMenuMysteryGift[] = _C("MYSTERY GIFT");
const u8 gText_MainMenuMysteryGift2[] = _C("MYSTERY GIFT");
const u8 gText_MainMenuMysteryEvents[] = _C("MYSTERY EVENTS");
#else
...
#if (DECAP_ENABLED) && !(DECAP_PLAYER_NAMES)
const u8 gText_DefaultNameStu[] = _C("STU");
const u8 gText_DefaultNameMilton[] = _C("MILTON");
const u8 gText_DefaultNameTom[] = _C("TOM");
const u8 gText_DefaultNameKenny[] = _C("KENNY");
const u8 gText_DefaultNameReid[] = _C("REID");
const u8 gText_DefaultNameJude[] = _C("JUDE");
const u8 gText_DefaultNameJaxson[] = _C("JAXSON");
const u8 gText_DefaultNameEaston[] = _C("EASTON");
const u8 gText_DefaultNameWalker[] = _C("WALKER");
const u8 gText_DefaultNameTeru[] = _C("TERU");
const u8 gText_DefaultNameJohnny[] = _C("JOHNNY");
const u8 gText_DefaultNameBrett[] = _C("BRETT");
const u8 gText_DefaultNameSeth[] = _C("SETH");
const u8 gText_DefaultNameTerry[] = _C("TERRY");
const u8 gText_DefaultNameCasey[] = _C("CASEY");
const u8 gText_DefaultNameDarren[] = _C("DARREN");
const u8 gText_DefaultNameLandon[] = _C("LANDON");
const u8 gText_DefaultNameCollin[] = _C("COLLIN");
const u8 gText_DefaultNameStanley[] = _C("STANLEY");
const u8 gText_DefaultNameQuincy[] = _C("QUINCY");
const u8 gText_DefaultNameKimmy[] = _C("KIMMY");
const u8 gText_DefaultNameTiara[] = _C("TIARA");
const u8 gText_DefaultNameBella[] = _C("BELLA");
const u8 gText_DefaultNameJayla[] = _C("JAYLA");
const u8 gText_DefaultNameAllie[] = _C("ALLIE");
const u8 gText_DefaultNameLianna[] = _C("LIANNA");
const u8 gText_DefaultNameSara[] = _C("SARA");
const u8 gText_DefaultNameMonica[] = _C("MONICA");
const u8 gText_DefaultNameCamila[] = _C("CAMILA");
const u8 gText_DefaultNameAubree[] = _C("AUBREE");
const u8 gText_DefaultNameRuthie[] = _C("RUTHIE");
const u8 gText_DefaultNameHazel[] = _C("HAZEL");
const u8 gText_DefaultNameNadine[] = _C("NADINE");
const u8 gText_DefaultNameTanja[] = _C("TANJA");
const u8 gText_DefaultNameYasmin[] = _C("YASMIN");
const u8 gText_DefaultNameNicola[] = _C("NICOLA");
const u8 gText_DefaultNameLillie[] = _C("LILLIE");
const u8 gText_DefaultNameTerra[] = _C("TERRA");
const u8 gText_DefaultNameLucy[] = _C("LUCY");
const u8 gText_DefaultNameHalie[] = _C("HALIE");
#else
...
const u8 gText_DexSearchAlphaABC[] = _C("ABC");
const u8 gText_DexSearchAlphaDEF[] = _C("DEF");
const u8 gText_DexSearchAlphaGHI[] = _C("GHI");
const u8 gText_DexSearchAlphaJKL[] = _C("JKL");
const u8 gText_DexSearchAlphaMNO[] = _C("MNO");
const u8 gText_DexSearchAlphaPQR[] = _C("PQR");
const u8 gText_DexSearchAlphaSTU[] = _C("STU");
const u8 gText_DexSearchAlphaVWX[] = _C("VWX");
const u8 gText_DexSearchAlphaYZ[] = _C("YZ");
...
#if (DECAP_ENABLED) && !(DECAP_PARTY_MENU)
const u8 gText_Item[] = _C("ITEM");
const u8 gText_Mail[] = _C("MAIL");
const u8 gText_Take[] = _C("TAKE");
const u8 gText_Store[] = _C("STORE");
const u8 gText_Cancel2[] = _C("CANCEL");
const u8 gMenuText_Give[] = _C("GIVE");
#else
...
#if (DECAP_ENABLED) && !(DECAP_PARTY_MENU)
const u8 gText_Switch2[] = _C("SWITCH");
const u8 gText_Summary5[] = _C("SUMMARY");
const u8 gText_Take2[] = _C("TAKE");
const u8 gText_Read2[] = _C("READ");
const u8 gText_Shift[] = _C("SHIFT");
const u8 gText_SendOut[] = _C("SEND OUT");
const u8 gText_Enter[] = _C("ENTER");
const u8 gText_NoEntry[] = _C("NO ENTRY");
const u8 gText_Trade4[] = _C("TRADE");
#else
...
#if (DECAP_ENABLED) && !(DECAP_PARTY_MENU)
const u8 gText_TeachWhichPokemon2[] = _C("Teach which POKéMON?"); // Unused
const u8 gText_ChoosePokemon[] = _C("Choose a POKéMON.");
const u8 gText_MoveToWhere[] = _C("Move to where?");
const u8 gText_TeachWhichPokemon[] = _C("Teach which POKéMON?");
const u8 gText_UseOnWhichPokemon[] = _C("Use on which POKéMON?");
const u8 gText_GiveToWhichPokemon[] = _C("Give to which POKéMON?");
const u8 gText_DoWhatWithPokemon[] = _C("Do what with this {PKMN}?");
const u8 gText_NothingToCut[] = _C("There's nothing to CUT.");
const u8 gText_CantSurfHere[] = _C("You can't SURF here.");
const u8 gText_AlreadySurfing[] = _C("You're already SURFING.");
const u8 gText_CantUseHere[] = _C("Can't use that here.");
const u8 gText_RestoreWhichMove[] = _C("Restore which move?");
const u8 gText_BoostPp[] = _C("Boost PP of which move?");
const u8 gText_DoWhatWithItem[] = _C("Do what with an item?");
const u8 gText_NoPokemonForBattle[] = _C("No POKéMON for battle!");
const u8 gText_ChoosePokemon2[] = _C("Choose a POKéMON.");
const u8 gText_NotEnoughHp[] = _C("Not enough HP…");
const u8 gText_PokemonAreNeeded[] = _C("{STR_VAR_1} POKéMON are needed.");
const u8 gText_PokemonCantBeSame[] = _C("POKéMON can't be the same.");
const u8 gText_NoIdenticalHoldItems[] = _C("No identical hold items.");
const u8 gText_CurrentIsTooFast[] = _C("The current is much too fast!");
const u8 gText_DoWhatWithMail[] = _C("Do what with the MAIL?");
const u8 gText_ChoosePokemonCancel[] = _C("Choose POKéMON or CANCEL.");
const u8 gText_ChoosePokemonConfirm[] = _C("Choose POKéMON and confirm.");
const u8 gText_EnjoyCycling[] = _C("Let's enjoy cycling!");
const u8 gText_InUseAlready_PM[] = _C("This is in use already.");
const u8 gText_AlreadyHoldingOne[] = _C("{STR_VAR_1} is already holding\none {STR_VAR_2}.");
const u8 gText_NoUse[] = _C("No use.");
const u8 gText_Able[] = _C("ABLE");
const u8 gText_First_PM[] = _C("FIRST");
const u8 gText_Second_PM[] = _C("SECOND");
const u8 gText_Third_PM[] = _C("THIRD");
const u8 gText_Able2[] = _C("ABLE");
const u8 gText_NotAble[] = _C("NOT ABLE");
const u8 gText_Able3[] = _C("ABLE!");
const u8 gText_NotAble2[] = _C("NOT ABLE!");
const u8 gText_Learned[] = _C("LEARNED");
const u8 gText_Have[] = _C("HAVE");
const u8 gText_DontHave[] = _C("DON'T HAVE");
const u8 gText_Fourth[] = _C("FOURTH");
const u8 gText_PkmnCantParticipate[] = _C("That POKéMON can't participate.{PAUSE_UNTIL_PRESS}");
const u8 gText_CancelParticipation[] = _C("Cancel participation?");
const u8 gText_CancelBattle[] = _C("Cancel the battle?");
const u8 gText_ReturnToWaitingRoom[] = _C("Return to the WAITING ROOM?");
const u8 gText_CancelChallenge[] = _C("Cancel the challenge?");
const u8 gText_EscapeFromHere[] = _C("Want to escape from here and return\nto {STR_VAR_1}?");
const u8 gText_ReturnToHealingSpot[] = _C("Want to return to the healing spot\nused last in {STR_VAR_1}?");
#else
...
#if (DECAP_ENABLED) && !(DECAP_PARTY_MENU)
const u8 gText_Register[] = _C("REGISTER");
#else
...
#if (DECAP_ENABLED) && !(DECAP_SUMMARY)
const u8 gText_Attack3[] = _C("ATTACK");
const u8 gText_Defense3[] = _C("DEFENSE");
const u8 gText_SpAtk4[] = _C("SP. ATK");
const u8 gText_SpDef4[] = _C("SP. DEF");
const u8 gText_Speed2[] = _C("SPEED");
const u8 gText_HP4[] = _C("HP");
const u8 gText_OTSlash[] = _C("OT/");
const u8 gText_RentalPkmn[] = _C("RENTAL POKéMON");
const u8 gText_TypeSlash[] = _C("TYPE/");
const u8 gText_Power[] = _C("POWER");
const u8 gText_Accuracy2[] = _C("ACCURACY");
const u8 gText_Appeal[] = _C("APPEAL");
const u8 gText_Jam[] = _C("JAM");
const u8 gText_Status[] = _C("STATUS");
const u8 gText_ExpPoints[] = _C("EXP. POINTS");
const u8 gText_NextLv[] = _C("NEXT LV.");
const u8 gText_RibbonsVar1[] = _C("RIBBONS: {STR_VAR_1}");
const u8 gText_PkmnInfo[] = _C("POKéMON INFO");
const u8 gText_PkmnSkills[] = _C("POKéMON SKILLS");
const u8 gText_BattleMoves[] = _C("BATTLE MOVES");
const u8 gText_ContestMoves[] = _C("CONTEST MOVES");
const u8 gText_Info[] = _C("INFO");
const u8 gText_EggWillTakeALongTime[] = _C("It looks like this EGG will\ntake a long time to hatch.");
const u8 gText_EggWillTakeSomeTime[] = _C("What will hatch from this?\nIt will take some time.");
const u8 gText_EggWillHatchSoon[] = _C("It moves occasionally.\nIt should hatch soon.");
const u8 gText_EggAboutToHatch[] = _C("It's making sounds.\nIt's about to hatch!");
const u8 gText_HMMovesCantBeForgotten2[] = _C("HM moves can't be\nforgotten now.");
const u8 gText_XNatureMetAtYZ[] = _C("{DYNAMIC 0}{DYNAMIC 2}{DYNAMIC 1}{DYNAMIC 5} nature,\nmet at {LV_2}{DYNAMIC 0}{DYNAMIC 3}{DYNAMIC 1},\n{DYNAMIC 0}{DYNAMIC 4}{DYNAMIC 1}.");
const u8 gText_XNatureHatchedAtYZ[] = _C("{DYNAMIC 0}{DYNAMIC 2}{DYNAMIC 1}{DYNAMIC 5} nature,\nhatched at {LV_2}{DYNAMIC 0}{DYNAMIC 3}{DYNAMIC 1},\n{DYNAMIC 0}{DYNAMIC 4}{DYNAMIC 1}.");
const u8 gText_XNatureObtainedInTrade[] = _C("{DYNAMIC 0}{DYNAMIC 2}{DYNAMIC 1}{DYNAMIC 5} nature,\nobtained in a trade.");
const u8 gText_XNatureFatefulEncounter[] = _C("{DYNAMIC 0}{DYNAMIC 2}{DYNAMIC 1}{DYNAMIC 5} nature,\nobtained in a fateful\nencounter at {LV_2}{DYNAMIC 0}{DYNAMIC 3}{DYNAMIC 1}.");
const u8 gText_XNatureProbablyMetAt[] = _C("{DYNAMIC 0}{DYNAMIC 2}{DYNAMIC 1}{DYNAMIC 5} nature,\nprobably met at {LV_2}{DYNAMIC 0}{DYNAMIC 3}{DYNAMIC 1},\n{DYNAMIC 0}{DYNAMIC 4}{DYNAMIC 1}.");
const u8 gText_XNature[] = _C("{DYNAMIC 0}{DYNAMIC 2}{DYNAMIC 1}{DYNAMIC 5} nature");
const u8 gText_XNatureMetSomewhereAt[] = _C("{DYNAMIC 0}{DYNAMIC 2}{DYNAMIC 1}{DYNAMIC 5} nature,\nmet somewhere at {LV_2}{DYNAMIC 0}{DYNAMIC 3}{DYNAMIC 1}.");
const u8 gText_XNatureHatchedSomewhereAt[] = _C("{DYNAMIC 0}{DYNAMIC 2}{DYNAMIC 1}{DYNAMIC 5} nature,\nhatched somewhere at {LV_2}{DYNAMIC 0}{DYNAMIC 3}{DYNAMIC 1}.");
const u8 gText_OddEggFoundByCouple[] = _C("An odd POKéMON EGG found\nby the DAY CARE couple.");
const u8 gText_PeculiarEggNicePlace[] = _C("A peculiar POKéMON EGG\nobtained at the nice place.");
const u8 gText_PeculiarEggTrade[] = _C("A peculiar POKéMON EGG\nobtained in a trade.");
const u8 gText_EggFromHotSprings[] = _C("A POKéMON EGG obtained\nat the hot springs.");
const u8 gText_EggFromTraveler[] = _C("An odd POKéMON EGG\nobtained from a traveler.");
#else
...
const u8 gText_Ok3[] = _C("OK"); // Unused
...
const u8 gText_SomeonesPC[] = _("SOMEONE'S P{}C");
const u8 gText_LanettesPC[] = _("LANETTE'S P{}C");
const u8 gText_PlayersPC[] = _("{PLAYER}'s P{}C");
...
#if (DECAP_ENABLED) && !(DECAP_START_MENU)
const u8 gText_MenuOptionPokedex[] = _C("POKéDEX");
const u8 gText_MenuOptionPokemon[] = _C("POKéMON");
const u8 gText_MenuOptionBag[] = _C("BAG");
const u8 gText_MenuOptionPokenav[] = _C("POKé{}NAV");
const u8 gText_MenuOptionSave[] = _C("SAVE");
const u8 gText_MenuOptionOption[] = _C("OPTION");
const u8 gText_MenuOptionExit[] = _C("EXIT");
#else
const u8 gText_MenuOptionPokedex[] = _("POKéDEX");
const u8 gText_MenuOptionPokemon[] = _("POKéMON");
const u8 gText_MenuOptionBag[] = _("BAG");
const u8 gText_MenuOptionPokenav[] = _("POKé{}NAV");
...
const u8 gText_5BP[] = _C("  5B{}P");
const u8 gText_10BP[] = _C("10B{}P");
const u8 gText_15BP[] = _C("15B{}P");
...
const u8 gText_PokenavAndBag[] = _("POKé{}NAV AND BAG");
...
const u8 gText_PutAwayPokenav[] = _("Put away the POKé{}NAV.");
...
const u8 gText_ReturnToPokenavMenu[] = _("Return to the POKé{}NAV menu.");
...
const u8 gText_KissPoster16BP[] = _("KISS POSTER{CLEAR_TO 0x5E}16B{}P");
const u8 gText_KissCushion32BP[] = _("KISS CUSHION{CLEAR_TO 0x5E}32B{}P");
const u8 gText_SmoochumDoll32BP[] = _("SMOOCHUM DOLL{CLEAR_TO 0x5E}32B{}P");
const u8 gText_TogepiDoll48BP[] = _("TOGEPI DOLL{CLEAR_TO 0x5E}48B{}P");
const u8 gText_MeowthDoll48BP[] = _("MEOWTH DOLL{CLEAR_TO 0x5E}48B{}P");
const u8 gText_ClefairyDoll48BP[] = _("CLEFAIRY DOLL{CLEAR_TO 0x5E}48B{}P");
const u8 gText_DittoDoll48BP[] = _("DITTO DOLL{CLEAR_TO 0x5E}48B{}P");
const u8 gText_CyndaquilDoll80BP[] = _("CYNDAQUIL DOLL{CLEAR_TO 0x5E}80B{}P");
const u8 gText_ChikoritaDoll80BP[] = _("CHIKORITA DOLL{CLEAR_TO 0x5E}80B{}P");
const u8 gText_TotodileDoll80BP[] = _("TOTODILE DOLL{CLEAR_TO 0x5E}80B{}P");
const u8 gText_LaprasDoll128BP[] = _("LAPRAS DOLL{CLEAR_TO 0x58}128B{}P");
const u8 gText_SnorlaxDoll128BP[] = _("SNORLAX DOLL{CLEAR_TO 0x58}128B{}P");
const u8 gText_VenusaurDoll256BP[] = _("VENUSAUR DOLL{CLEAR_TO 0x58}256B{}P");
const u8 gText_CharizardDoll256BP[] = _("CHARIZARD DOLL{CLEAR_TO 0x58}256B{}P");
const u8 gText_BlastoiseDoll256BP[] = _("BLASTOISE DOLL{CLEAR_TO 0x58}256B{}P");
const u8 gText_Protein1BP[] = _("PROTEIN{CLEAR_TO 0x64}1B{}P");
const u8 gText_Calcium1BP[] = _("CALCIUM{CLEAR_TO 0x64}1B{}P");
const u8 gText_Iron1BP[] = _("IRON{CLEAR_TO 0x64}1B{}P");
const u8 gText_Zinc1BP[] = _("ZINC{CLEAR_TO 0x64}1B{}P");
const u8 gText_Carbos1BP[] = _("CARBOS{CLEAR_TO 0x64}1B{}P");
const u8 gText_HpUp1BP[] = _("HP UP{CLEAR_TO 0x64}1B{}P");
const u8 gText_Leftovers48BP[] = _("LEFTOVERS{CLEAR_TO 0x5E}48B{}P");
const u8 gText_WhiteHerb48BP[] = _("WHITE HERB{CLEAR_TO 0x5E}48B{}P");
const u8 gText_QuickClaw48BP[] = _("QUICK CLAW{CLEAR_TO 0x5E}48B{}P");
const u8 gText_MentalHerb48BP[] = _("MENTAL HERB{CLEAR_TO 0x5E}48B{}P");
const u8 gText_BrightPowder64BP[] = _("BRIGHTPOWDER{CLEAR_TO 0x5E}64B{}P");
const u8 gText_ChoiceBand64BP[] = _("CHOICE BAND{CLEAR_TO 0x5E}64B{}P");
const u8 gText_KingsRock64BP[] = _("KING'S ROCK{CLEAR_TO 0x5E}64B{}P");
const u8 gText_FocusBand64BP[] = _("FOCUS BAND{CLEAR_TO 0x5E}64B{}P");
const u8 gText_ScopeLens64BP[] = _("SCOPE LENS{CLEAR_TO 0x5E}64B{}P");
const u8 gText_Softboiled16BP[] = _("SOFTBOILED{CLEAR_TO 0x4E}16B{}P");
const u8 gText_SeismicToss24BP[] = _("SEISMIC TOSS{CLEAR_TO 0x4E}24B{}P");
const u8 gText_DreamEater24BP[] = _("DREAM EATER{CLEAR_TO 0x4E}24B{}P");
const u8 gText_MegaPunch24BP[] = _("MEGA PUNCH{CLEAR_TO 0x4E}24B{}P");
const u8 gText_MegaKick48BP[] = _("MEGA KICK{CLEAR_TO 0x4E}48B{}P");
const u8 gText_BodySlam48BP[] = _("BODY SLAM{CLEAR_TO 0x4E}48B{}P");
const u8 gText_RockSlide48BP[] = _("ROCK SLIDE{CLEAR_TO 0x4E}48B{}P");
const u8 gText_Counter48BP[] = _("COUNTER{CLEAR_TO 0x4E}48B{}P");
const u8 gText_ThunderWave48BP[] = _("THUNDER WAVE{CLEAR_TO 0x4E}48B{}P");
const u8 gText_SwordsDance48BP[] = _("SWORDS DANCE{CLEAR_TO 0x4E}48B{}P");
const u8 gText_DefenseCurl16BP[] = _("DEFENSE CURL{CLEAR_TO 0x4E}16B{}P");
const u8 gText_Snore24BP[] = _("SNORE{CLEAR_TO 0x4E}24B{}P");
const u8 gText_MudSlap24BP[] = _("MUD-SLAP{CLEAR_TO 0x4E}24B{}P");
const u8 gText_Swift24BP[] = _("SWIFT{CLEAR_TO 0x4E}24B{}P");
const u8 gText_IcyWind24BP[] = _("ICY WIND{CLEAR_TO 0x4E}24B{}P");
const u8 gText_Endure48BP[] = _("ENDURE{CLEAR_TO 0x4E}48B{}P");
const u8 gText_PsychUp48BP[] = _("PSYCH UP{CLEAR_TO 0x4E}48B{}P");
const u8 gText_IcePunch48BP[] = _("ICE PUNCH{CLEAR_TO 0x4E}48B{}P");
const u8 gText_ThunderPunch48BP[] = _("THUNDERPUNCH{CLEAR_TO 0x4E}48B{}P");
const u8 gText_FirePunch48BP[] = _("FIRE PUNCH{CLEAR_TO 0x4E}48B{}P");
...
const u8 gText_NumBP[] = _("{STR_VAR_1}{COLOR DARK_GRAY}{SHADOW LIGHT_GRAY}B{}P");
...
#if (DECAP_ENABLED) && !(DECAP_MAIN_MENU)
const u8 gText_ContinueMenuPlayer[] = _C("PLAYER");
const u8 gText_ContinueMenuTime[] = _C("TIME");
const u8 gText_ContinueMenuPokedex[] = _C("POKéDEX");
const u8 gText_ContinueMenuBadges[] = _C("BADGES");
#else
...
#if (DECAP_ENABLED) && !(DECAP_OPTION_MENU)
const u8 gText_Option[] = _C("OPTION");
const u8 gText_TextSpeed[] = _C("TEXT SPEED");
const u8 gText_BattleScene[] = _C("BATTLE SCENE");
const u8 gText_BattleStyle[] = _C("BATTLE STYLE");
const u8 gText_Sound[] = _C("SOUND");
const u8 gText_Frame[] = _C("FRAME");
const u8 gText_OptionMenuCancel[] = _C("CANCEL");
#else
...
#if (DECAP_ENABLED) && !(DECAP_START_MENU)
const u8 gText_MenuPokedex[] = _C("POKéDEX");
const u8 gText_MenuPokemon[] = _C("POKéMON");
const u8 gText_MenuBag[] = _C("BAG");
const u8 gText_MenuPokenav[] = _C("POKé{}NAV");
const u8 gText_MenuPlayer[] = _C("{PLAYER}");
const u8 gText_MenuSave[] = _C("SAVE");
const u8 gText_MenuOption[] = _C("OPTION");
const u8 gText_MenuExit[] = _C("EXIT");
const u8 gText_MenuRetire[] = _C("RETIRE");
const u8 gText_MenuRest[] = _C("REST");
#else
const u8 gText_MenuPokedex[] = _("POKéDEX");
const u8 gText_MenuPokemon[] = _("POKéMON");
const u8 gText_MenuBag[] = _("BAG");
const u8 gText_MenuPokenav[] = _("POKé{}NAV");
...
#if (DECAP_ENABLED) && !(DECAP_START_MENU)
const u8 gText_SavingPlayer[] = _C("PLAYER");
const u8 gText_SavingBadges[] = _C("BADGES");
const u8 gText_SavingPokedex[] = _C("POKéDEX");
const u8 gText_SavingTime[] = _C("TIME");
#else
...
#if (DECAP_ENABLED) && !(DECAP_PARTY_MENU)
ALIGNED(4) const u8 gText_Toss[] = _C("TOSS");
#else
