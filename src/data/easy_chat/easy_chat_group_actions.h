const u8 gEasyChatWord_Meets[] = _E("MEETS");
const u8 gEasyChatWord_Concede[] = _E("CONCEDE");
const u8 gEasyChatWord_Give[] = _E("GIVE");
const u8 gEasyChatWord_Gives[] = _E("GIVES");
const u8 gEasyChatWord_Played[] = _E("PLAYED");
const u8 gEasyChatWord_Plays[] = _E("PLAYS");
const u8 gEasyChatWord_Collect[] = _E("COLLECT");
const u8 gEasyChatWord_Walking[] = _E("WALKING");
const u8 gEasyChatWord_Walks[] = _E("WALKS");
const u8 gEasyChatWord_Says[] = _E("SAYS");
const u8 gEasyChatWord_Went[] = _E("WENT");
const u8 gEasyChatWord_Said[] = _E("SAID");
const u8 gEasyChatWord_WakeUp[] = _E("WAKE UP");
const u8 gEasyChatWord_WakesUp[] = _E("WAKES UP");
const u8 gEasyChatWord_Angers[] = _E("ANGERS");
const u8 gEasyChatWord_Teach[] = _E("TEACH");
const u8 gEasyChatWord_Teaches[] = _E("TEACHES");
const u8 gEasyChatWord_Please[] = _E("PLEASE");
const u8 gEasyChatWord_Learn[] = _E("LEARN");
const u8 gEasyChatWord_Change[] = _E("CHANGE");
const u8 gEasyChatWord_Story[] = _E("STORY");
const u8 gEasyChatWord_Trust[] = _E("TRUST");
const u8 gEasyChatWord_Lavish[] = _E("LAVISH");
const u8 gEasyChatWord_Listens[] = _E("LISTENS");
const u8 gEasyChatWord_Hearing[] = _E("HEARING");
const u8 gEasyChatWord_Trains[] = _E("TRAINS");
const u8 gEasyChatWord_Choose[] = _E("CHOOSE");
const u8 gEasyChatWord_Come[] = _E("COME");
const u8 gEasyChatWord_Came[] = _E("CAME");
const u8 gEasyChatWord_Search[] = _E("SEARCH");
const u8 gEasyChatWord_Make[] = _E("MAKE");
const u8 gEasyChatWord_Cause[] = _E("CAUSE");
const u8 gEasyChatWord_Know[] = _E("KNOW");
const u8 gEasyChatWord_Knows[] = _E("KNOWS");
const u8 gEasyChatWord_Refuse[] = _E("REFUSE");
const u8 gEasyChatWord_Stores[] = _E("STORES");
const u8 gEasyChatWord_Brag[] = _E("BRAG");
const u8 gEasyChatWord_Ignorant[] = _E("IGNORANT");
const u8 gEasyChatWord_Thinks[] = _E("THINKS");
const u8 gEasyChatWord_Believe[] = _E("BELIEVE");
const u8 gEasyChatWord_Slide[] = _E("SLIDE");
const u8 gEasyChatWord_Eats[] = _E("EATS");
const u8 gEasyChatWord_Use[] = _E("USE");
const u8 gEasyChatWord_Uses[] = _E("USES");
const u8 gEasyChatWord_Using[] = _E("USING");
const u8 gEasyChatWord_Couldnt[] = _E("COULDN'T");
const u8 gEasyChatWord_Capable[] = _E("CAPABLE");
const u8 gEasyChatWord_Disappear[] = _E("DISAPPEAR");
const u8 gEasyChatWord_Appear[] = _E("APPEAR");
const u8 gEasyChatWord_Throw[] = _E("THROW");
const u8 gEasyChatWord_Worry[] = _E("WORRY");
const u8 gEasyChatWord_Slept[] = _E("SLEPT");
const u8 gEasyChatWord_Sleep[] = _E("SLEEP");
const u8 gEasyChatWord_Release[] = _E("RELEASE");
const u8 gEasyChatWord_Drinks[] = _E("DRINKS");
const u8 gEasyChatWord_Runs[] = _E("RUNS");
const u8 gEasyChatWord_Run[] = _E("RUN");
const u8 gEasyChatWord_Works[] = _E("WORKS");
const u8 gEasyChatWord_Working[] = _E("WORKING");
const u8 gEasyChatWord_Talking[] = _E("TALKING");
const u8 gEasyChatWord_Talk[] = _E("TALK");
const u8 gEasyChatWord_Sink[] = _E("SINK");
const u8 gEasyChatWord_Smack[] = _E("SMACK");
const u8 gEasyChatWord_Pretend[] = _E("PRETEND");
const u8 gEasyChatWord_Praise[] = _E("PRAISE");
const u8 gEasyChatWord_Overdo[] = _E("OVERDO");
const u8 gEasyChatWord_Show[] = _E("SHOW");
const u8 gEasyChatWord_Looks[] = _E("LOOKS");
const u8 gEasyChatWord_Sees[] = _E("SEES");
const u8 gEasyChatWord_Seek[] = _E("SEEK");
const u8 gEasyChatWord_Own[] = _E("OWN");
const u8 gEasyChatWord_Take[] = _E("TAKE");
const u8 gEasyChatWord_Allow[] = _E("ALLOW");
const u8 gEasyChatWord_Forget[] = _E("FORGET");
const u8 gEasyChatWord_Forgets[] = _E("FORGETS");
const u8 gEasyChatWord_Appears[] = _E("APPEARS");
const u8 gEasyChatWord_Faint[] = _E("FAINT");
const u8 gEasyChatWord_Fainted[] = _E("FAINTED");
