const u8 gEasyChatWord_Thanks[] = _E("THANKS");
const u8 gEasyChatWord_Yes[] = _E("YES");
const u8 gEasyChatWord_HereGoes[] = _E("HERE GOES");
const u8 gEasyChatWord_HereICome[] = _E("HERE I COME");
const u8 gEasyChatWord_HereItIs[] = _E("HERE IT IS");
const u8 gEasyChatWord_Yeah[] = _E("YEAH");
const u8 gEasyChatWord_Welcome[] = _E("WELCOME");
const u8 gEasyChatWord_Oi[] = _E("OI");
const u8 gEasyChatWord_HowDo[] = _E("HOW DO");
const u8 gEasyChatWord_Congrats[] = _E("CONGRATS");
const u8 gEasyChatWord_GiveMe[] = _E("GIVE ME");
const u8 gEasyChatWord_Sorry[] = _E("SORRY");
const u8 gEasyChatWord_Apologize[] = _E("APOLOGIZE");
const u8 gEasyChatWord_Forgive[] = _E("FORGIVE");
const u8 gEasyChatWord_HeyThere[] = _E("HEY, THERE");
const u8 gEasyChatWord_Hello[] = _E("HELLO");
const u8 gEasyChatWord_GoodBye[] = _E("GOOD-BYE");
const u8 gEasyChatWord_ThankYou[] = _E("THANK YOU");
const u8 gEasyChatWord_IveArrived[] = _E("I'VE ARRIVED");
const u8 gEasyChatWord_Pardon[] = _E("PARDON");
const u8 gEasyChatWord_Excuse[] = _E("EXCUSE");
const u8 gEasyChatWord_SeeYa[] = _E("SEE YA");
const u8 gEasyChatWord_ExcuseMe[] = _E("EXCUSE ME");
const u8 gEasyChatWord_WellThen[] = _E("WELL, THEN");
const u8 gEasyChatWord_GoAhead[] = _E("GO AHEAD");
const u8 gEasyChatWord_Appreciate[] = _E("APPRECIATE");
const u8 gEasyChatWord_HeyQues[] = _E("HEY?");
const u8 gEasyChatWord_WhatsUpQues[] = _E("WHAT'S UP?");
const u8 gEasyChatWord_HuhQues[] = _E("HUH?");
const u8 gEasyChatWord_No[] = _E("NO");
const u8 gEasyChatWord_Hi[] = _E("HI");
const u8 gEasyChatWord_YeahYeah[] = _E("YEAH, YEAH");
const u8 gEasyChatWord_ByeBye[] = _E("BYE-BYE");
const u8 gEasyChatWord_MeetYou[] = _E("MEET YOU");
const u8 gEasyChatWord_Hey[] = _E("HEY");
const u8 gEasyChatWord_Smell[] = _E("SMELL");
const u8 gEasyChatWord_Listening[] = _E("LISTENING");
const u8 gEasyChatWord_HooHah[] = _E("HOO-HAH");
const u8 gEasyChatWord_Yahoo[] = _E("YAHOO");
const u8 gEasyChatWord_Yo[] = _E("YO");
const u8 gEasyChatWord_ComeOver[] = _E("COME OVER");
const u8 gEasyChatWord_CountOn[] = _E("COUNT ON");
