...
// With DECAP_ENABLED, this is a zero-width space;
// when disabled, it's a normal width space.
// Use it to decap phrases like "IRON{ZW_SPACE}THORNS"
// into "IronThorns" or "IRON THORNS", depending
